    ...
    return (
      <Query query={CURRENT_USER}>
        {({ loading, error, data }) => {
          ...
          return (
            <Mutation
              mutation={FUMIGATION_QUOTE}
              awaitRefetchQueries={true}
              refetchQueries={[{ query: FUMIGATION_QUOTES }]}
            >
                  ...
                  onSubmit={values => {
                    ...
                    RNPaystack.chargeCard({
                      ...
                      .then(res => {
                        fumigationQuote({
                          variables: {
                            subscriptionType: "Fumigation Service",
                            house_type: Number(item.house_type),
                            land_plot: Number(item.land_plot),
                            fumigation_type: Number(item.fumigation_type),
                            isChecked_inter_bedBug: Number(
                              item.isChecked_inter_bedBug
                            ),
                            isChecked_inter_mosquito: Number(
                              item.isChecked_inter_mosquito
                            ),
                            isChecked_inter_termite: Number(
                              item.isChecked_inter_termite
                            ),
                            isChecked_inter_rats: Number(
                              item.isChecked_inter_rats
                            ),
                            isChecked_exter_mosquito: Number(
                              item.isChecked_exter_mosquito
                            ),
                            isChecked_exter_termite: Number(
                              item.isChecked_exter_termite
                            ),
                            isChecked_exter_rats: Number(
                              item.isChecked_exter_rats
                            ),
                            isChecked_exter_snakes: Number(
                              item.isChecked_exter_snakes
                            ),
