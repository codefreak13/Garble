      ...
      >
        <View style={styles.main}>
          ...
          <Text style={styles.serviceText}>
            ...
            (collectively, the “Service”) affords you access to waste management
            services and also provides you an opportunity to earn therein. The
            Service is operated by Garble Nigeria Limited (“Garble”), subject to
          ...
          <Text style={styles.serviceText}>
            ...
            number; (b) agree to the creation of an account associated with such
            number; (c) accept the present Terms; and (d) submit such other and
            additional information as Garble may request. You agree to provide
            true, accurate and complete information about yourself as prompted
            by Garble during the account registration process. You will be given
            the option of receiving a unique PIN for purposes of reusing your
            account. You are responsible for keeping your PIN secure.
          </Text>
          <Text style={styles.subHeader}>
          ...
          <Text style={styles.serviceText}>
            ...
            Service with the billing solutions of certain mobile money providers
            and credit card issuing banks (“Payment Processors”). If you
            purchase a Product using your supported mobile money wallet or
            ...
            or liable for any transactions in which you engage. By engaging in a
            purchase transaction using your mobile money account or credit card,
            you authorize the Merchant (or Garble on its behalf) to bill your
            account or card for the purchase amount.
          </Text>
          <Text style={styles.subHeader}>
          ...
          <Text style={styles.serviceText}>
            ...
            Policy is incorporated into these Terms by this reference. By using
            the Service, you agree to the use of your data in accordance with
            Garble’s Privacy Policy. The Privacy Policy addresses only the
            information collected by Garble in providing the Service to you.
            Merchants and Payment Processors have their own information
          ...
          <Text style={styles.serviceText}>
            If you have any questions, concerns or requests related to a Product
            you have purchased from a Garble, you should contact us at
          ...
          <Text style={styles.serviceText}>
            ...
            of the Service. In the event Garble has the suspicion you are using
            the Services for illegal activities such as fraud, Garble will block
          ...
          <Text style={styles.serviceText}>
            ...
            to time, receive communications from Garble via email, instant
            message, telephone, text message (SMS) or other means. You may stop
            receiving promotional messages by emailing your request to opt-out,
            along with your cell phone number, to support@Garble.team, or
            following the opt-out instructions in the message. Even if you
            choose to opt out of receiving promotional messages, you may not opt
          ...
          <Text style={styles.serviceText}>
            THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND. Garble
            AND ITS SUPPLIERS AND AFFILIATES DISCLAIM ALL WARRANTIES WITH REGARD
            TO THE SERVICE, INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY,
            FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. IF
            YOU ARE DISSATISFIED WITH ANY PORTION OF THE SERVICE, OR WITH ANY OF
          ...
          <Text style={styles.serviceText}>
            IN NO EVENT SHALL Garble OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, CONSEQUENTIAL DAMAGES, OR
            ANY DAMAGES WHATSOEVER ARISING OUT OF OR IN ANY WAY CONNECTED WITH
            THE USE OR PERFORMANCE OF THE SERVICE, WITH THE DELAY OR INABILITY
            TO USE THE SERVICE, THE PROVISION OF OR FAILURE TO PROVIDE SERVICES,
            OR OTHERWISE ARISING OUT OF THE USE OF THE SERVICE, WHETHER BASED ON
            CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY, OR OTHERWISE, EVEN IF
            Garble OR ANY OF ITS SUPPLIERS HAVE BEEN ADVISED OF THE POSSIBILITY
            OF SUCH DAMAGES.
          </Text>
          <Text style={styles.subHeader}>
          ...
          <Text style={styles.serviceText}>
            ...
            construed in accordance with the laws of Nigeria, without reference
            to the principles of conflict of laws thereof. Any matters arising
            concerning the interpretation, validity or implementation of this
            Agreement not solved by mutual agreement between the Parties shall
            be submitted to arbitration in the English language before a sole
            arbitrator to take place in Lagos, Nigeria as the seat of the
            arbitration. The arbitration shall be conducted pursuant to the
            Rules of Arbitration of the Chartered Institute of Arbitrators of
            the United Kingdom. The arbitral decision shall be final and binding
            on the Parties and may be made an order of court. The Parties
            unconditionally consent and submit to the jurisdiction of the High
            Court of Lagos, Nigeria for such purpose. Nothing in this Agreement
            will be deemed as preventing Garble from seeking injunctive relief
            ...
            necessary to protect Garble’s name, proprietary information, trade
          ...
          <Text style={styles.serviceText}>
            ...
            Privacy Policy) may be modified by Garble without notice at any time
            in the future. Changes will be posted. By using the Service, you
            agree to be bound by the latest version of these Terms. It is your
            responsibility to remain informed of any changes.
          </Text>
          <Text style={styles.subHeader}>13. Alteration.</Text>
          <Text style={styles.serviceText}>
            No alteration, variation or agreed cancellation of this agreement,
            and this paragraph, shall be of any effect unless directed so by us.
          </Text>
          ...
          <Text style={styles.serviceText}>
            ...
            the provisions of this Agreement (excluding only those provisions
            which are essential at law for a valid and binding Agreement to be
          ...
          <Text style={styles.privacy}>
            ...
            phone number directly from your device if possible. Garble uses the
            data to deliver the Service and maintain a customer relationship,
            including processing refund claims.
          </Text>
          <Text style={styles.privacy}>
          ...
          <Text style={styles.privacy}>
            ...
            effectively and allows our users to receive advertisements that are
            relevant to their needs. Garble never shares individual personal
            information with anyone, so an advertiser will never know that a
            specific user clicked on that advertiser’s advertisement.
          </Text>
          <Text style={styles.privacy}>
            D. Garble uses the above-described information to tailor the Service
            to suit user needs and help our advertisers better understand our
            audience demographics. We do not share information about individual
            users with any third party.
          </Text>
          <Text style={styles.privacy}>
            E. Garble reserves the right to disclose any information we have as
          ...
          <Text style={styles.privacy}>
            ...
            information, or if you have any inquiries on the processing of your
            data, you may contact us at privacy@Garble.team.
          </Text>
          <Text style={styles.privacy}>
            G. By using any part of the Service, you acknowledge and agree to
            the processing of your personal data, under the terms and conditions
