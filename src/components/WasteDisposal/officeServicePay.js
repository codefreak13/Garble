...
class OfficeServicePay extends React.Component {
  state = {
    cardNum: "",
    cardExpiryMonth: "",
    cardExpiryYear: "",
                  ...
                  onSubmit={values => {
                    ...
                    RNPaystack.chargeCard({
                      ...
                      .then(res => {
                        createOfficeQuote({
                          variables: {
                            subscriptionType: "Office Waste Collection",
                            amount: item.amount,
...
export default OfficeServicePay;
