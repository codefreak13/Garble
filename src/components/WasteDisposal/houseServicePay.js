...
class HouseHoldPay extends React.Component {
  state = {
    cardNum: "",
    cardExpiryMonth: "",
    cardExpiryYear: "",
                  ...
                  onSubmit={values => {
                    ...
                    RNPaystack.chargeCard({
                      ...
                      .then(res => {
                        createHouseQuote({
                          variables: {
                            subscriptionType: "Household Waste Collection",
                            amount: item.amount,
