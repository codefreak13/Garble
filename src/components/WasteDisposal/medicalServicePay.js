...
class MedicalServicePay extends React.Component {
  state = {
    cardNum: "",
    cardExpiryMonth: "",
    cardExpiryYear: "",
    ...
    return (
      <Query query={CURRENT_USER}>
        {({ loading, error, data }) => {
          ...
          return (
            <Mutation
              mutation={MEDICAL_WASTE}
              awaitRefetchQueries={true}
              refetchQueries={[{ query: WASTE_COLLECTION_QUOTES }]}
            >
              {(createMedicalQuote, { loading }) => (
                <Formik
                  initialValues={{
                    cardNum: "",
                    cardExpiryMonth: "",
                  ...
                  onSubmit={values => {
                    ...
                    RNPaystack.chargeCard({
                      ...
                      .then(res => {
                        createMedicalQuote({
                          variables: {
                            subscriptionType: "Medical Waste Collection",
                            amount: item.amount,
...
export default MedicalServicePay;
