    ...
    return (
      <Query query={CURRENT_USER}>
        {({ loading, error, data }) => {
          ...
          return (
            <Mutation
              mutation={MOBILE_TOILET}
              awaitRefetchQueries={true}
              refetchQueries={[{ query: MOBILE_TOILET_QUOTE }]}
            >
              {(CreateMobileToiletQuote, { loading }) => (
                <Formik
                  initialValues={{
                    cardNum: "",
                    cardExpiryMonth: "",
                    ...
                    RNPaystack.chargeCard({
                      ...
                      .then(res => {
                        ...
                        CreateMobileToiletQuote({
                          variables: {
                            subscriptionType: "Mobile Toilet Rentals",
                            selectedStartDate: item.selectedStartDate
                              .toString()
                              .slice(0, 16),
                            single_economy_class: Number(
                              item.single_economy_class
                            ),
                            double_economy_class: Number(
                              item.double_economy_class
                            ),
                            single_vip_class: Number(item.single_vip_class),
                            double_vip_class: Number(item.double_vip_class),
                            subtotal: Number(item.subtotal),
                            single_economy_service_duration: Number(
                              item.single_economy_service_duration
                            ),
                            double_economy_service_duration: Number(
                              item.double_economy_service_duration
                            ),
                            single_vip_service_duration: Number(
                              item.single_vip_service_duration
                            ),
                            double_vip_service_duration: Number(
                              item.double_vip_service_duration
                            ),
                            single_economy_class_value: Number(
                              item.single_economy_class_value
                            ),
                            double_economy_class_value: Number(
                              item.double_economy_class_value
                            ),
                            single_vip_class_value: Number(
                              item.single_vip_class_value
                            ),
                            double_vip_class_value: Number(
                              item.double_vip_class_value
                            ),
