...
import { MOBILE_TOILET_QUOTE } from "../QueryAndMutation";
import Root from "../Utils/Root";
import ListItem from "../Utils/ListItem";
import ActivityIndicatorPage from "../Utils/ActivityIndicator";
import ErrorPage from "../ErrorPage";
class MobileToiletSubscriptions extends Component {
  static navigationOptions = ({ navigation }) => {
    const { params = {} } = navigation.state;
    return {
      title: "Mobile Toilet Rentals Subscriptions",
      headerStyle: {
...
export default MobileToiletSubscriptions;
